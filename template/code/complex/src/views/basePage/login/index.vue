    ...
    <div class="flex h-full mx-auto relative">
      ...
      >
        <div class="flex items-center relative dark:text-white">
          <img src="@/assets/img/logo.png" alt="" class="h-48px mr-10px w-48px" />
        ...
        <div class="flex h-[calc(100%-60px)] justify-center items-center">
          ...
          >
            ...
            <div key="3" class="font-normal mt-5 text-14px dark:text-white"></div>
          </TransitionGroup>
        </div>
      </div>
      <div class="flex-1 p-30px relative <sm:p-10px dark:bg-dan-dark">
        <div class="flex justify-between items-center @xl:justify-end @2xl:justify-end">
